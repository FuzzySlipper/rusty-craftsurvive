...
- `.runtime/runtime-pack-8393ceb67765/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.8393ceb67765.nupkg` is the exact SDK
