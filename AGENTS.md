...
- `.runtime/runtime-pack-6d7e081997fc/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.6d7e081997fc.nupkg` is the exact SDK
