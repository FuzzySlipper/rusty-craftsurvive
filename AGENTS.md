...
- `.runtime/pair-538724836d65/runtime-pack/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.538724836d65.nupkg` is the exact SDK
