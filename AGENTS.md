...
- `.runtime/runtime-pack-d5c44a138073-audit18/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.d5c44a138073.audit18.nupkg` is the exact SDK
