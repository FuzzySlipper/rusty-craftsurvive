...
- `.runtime/runtime-pack-e7107c471eb9/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.e7107c471eb9.nupkg` is the exact SDK
