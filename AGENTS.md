...
- `.runtime/runtime-pack-a7a2216fc107/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.a7a2216fc107.nupkg` is the exact SDK
