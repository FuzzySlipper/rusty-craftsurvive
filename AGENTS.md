...
- `.runtime/runtime-pack-2574cc89fd30-audit4/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.2574cc89fd30.audit4.nupkg` is the exact SDK
