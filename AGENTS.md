...
- `.runtime/runtime-pack-78b0f94b9815/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.78b0f94b9815.nupkg` is the exact SDK
