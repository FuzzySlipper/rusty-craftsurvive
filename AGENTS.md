...
- `.runtime/runtime-pack-f6c44bb9fd73/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.f6c44bb9fd73.nupkg` is the exact SDK
