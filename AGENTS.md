...
- `.runtime/runtime-pack-50911d16e60f/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.50911d16e60f.nupkg` is the exact SDK
