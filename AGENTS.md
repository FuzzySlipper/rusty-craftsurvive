...
- `.runtime/runtime-pack-11eb8178488c-followups/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.11eb8178488c.nupkg` is the exact SDK
