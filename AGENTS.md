...
- `.runtime/pair-baf031173e19/runtime-pack/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.baf031173e19.nupkg` is the exact SDK
