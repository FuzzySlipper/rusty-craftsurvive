...
- `.runtime/runtime-pack-59c8de10668f/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.59c8de10668f.nupkg` is the exact SDK
