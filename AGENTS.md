...
- `.runtime/runtime-pack-b777eb3e488b/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.b777eb3e488b.nupkg` is the exact SDK
