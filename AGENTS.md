...
- `.runtime/runtime-pack-af51a286-delivery-sprites/` is the current runtime pack. Its `bin/rusty dev`
  command is the only normal loader and stages the CoreCLR product.
- `.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.af51a286c97b.nupkg` is the exact SDK
