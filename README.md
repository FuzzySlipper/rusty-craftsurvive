...
.runtime/
  runtime-pack-2fc3f400/  paired `rusty dev` runtime
...
```bash
./.runtime/runtime-pack-2fc3f400/bin/rusty dev \
  --runtime ./.runtime/runtime-pack-2fc3f400 \
...
`.runtime/runtime-pack-2fc3f400/` and
`.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.2fc3f400.nupkg` form one installed,
