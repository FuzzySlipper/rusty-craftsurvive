...
.runtime/
  runtime-pack-2574cc89fd30-gamepad2/  paired `rusty dev` runtime
...
`.runtime/runtime-pack-2574cc89fd30-gamepad2/` and
`.runtime/sdk-feed/Rusty.Engine.0.1.0-dev.2574cc89fd30.gamepad1.nupkg` form one installed,
