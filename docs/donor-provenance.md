...
| `content/textures/` | Canonical terrain atlas, sky panorama, source images, and checked metadata | The active C# sky slice selects the panorama through Engine Appearance and CameraView; terrain remains flat-colored until Engine task #7665 adds face-directed atlas mapping. Browser copies are not content authority. |
